          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-secondary border border-border rounded px-3 py-2.5 pr-10 text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-1 focus:ring-gold transition-shadow"
              />
              <button
                type="button"
